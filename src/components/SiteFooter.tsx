  ...
  return (
    <footer className="mt-12 border-t border-border bg-secondary px-4 py-8 text-sm text-muted-foreground">
      <p className="mx-auto max-w-5xl leading-relaxed">
        ...
        existence of a community-driven project like this is one of the things that makes sports,
        especially baseball, so beautiful, and I'm so glad that I get to be a small part of it. Credits to the
